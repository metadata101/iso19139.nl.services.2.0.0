...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern id="Validatie tegen het Nederlands metadata profiel op ISO 19119">
    ...
    <sch:let name="qos_criteria" value="//gmd:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:report/gmd:DQ_ConceptualConsistency"/>
  ...
  -->
      ...
      <sch:assert id="Metadata ID (ISO nr. 2)" test="$fileIdentifier">Metadata ID (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#metadata-unieke-identifier) ontbreekt of heeft een verkeerde waarde.</sch:assert>
      <sch:report id="Metadata ID (ISO nr. 2) info" test="$fileIdentifier">Metadata ID: <sch:value-of select="$fileIdentifier"/>
      </sch:report>
      <sch:assert id="De metadata taal (ISO nr. 3)" test="$mdLanguage">De metadata taal (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#taal-van-de-metadata) ontbreekt of heeft een verkeerde waarde. Dit hoort een waarde en verwijzing naar de codelijst te zijn.</sch:assert>
      <sch:report id="De metadata taal (ISO nr. 3) info" test="$mdLanguage">Metadata taal (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#taal-van-de-metadata) voldoet
      </sch:report>
      <sch:assert id="Hierarchieniveau (ISO nr. 6)" test="$hierarchyLevel">Hierarchieniveau (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#hi%C3%ABrarchieniveau) ontbreekt of heeft een verkeerde waarde</sch:assert>
      <sch:report id="Hierarchieniveau (ISO nr. 6) info" test="$hierarchyLevel">Hierarchieniveau (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#hi%C3%ABrarchieniveau) voldoet
      </sch:report>
      <sch:assert id="Hierarchieniveau naam" test="$hierarchyLevelName">Hierarchieniveau naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#hi%C3%ABrarchieniveaunaam) ontbreekt of heeft een verkeerde waarde</sch:assert>
      <sch:report id="Hierarchieniveau naam" test="$hierarchyLevelName">Hierarchieniveau naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#hi%C3%ABrarchieniveaunaam) voldoet
      </sch:report>

      <sch:assert id="Naam organisatie metadata (ISO nr. 376)" test="$mdResponsibleParty_OrganisationString or $mdResponsibleParty_OrganisationURI">Naam organisatie metadata (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-metadata) ontbreekt</sch:assert>
      ...
      <sch:assert id="Rol organisatie metadata (ISO nr. 379)" test="$mdResponsibleParty_Role">Rol organisatie metadata (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-metadata:-rol) ontbreekt of heeft een verkeerde waarde</sch:assert>
      <sch:report id="Rol organisatie metadata (ISO nr. 379) info" test="$mdResponsibleParty_Role">Rol organisatie metadata (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-metadata:-rol) <sch:value-of select="$mdResponsibleParty_Role"/>
      </sch:report>
      ...
      <sch:assert id="E-mail organisatie metadata (ISO nr. 386)" test="$mdResponsibleParty_Mail">E-mail organisatie metadata (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-metadata:-e-mail) ontbreekt</sch:assert>
      <sch:report id="E-mail organisatie metadata (ISO nr. 386) info" test="$mdResponsibleParty_Mail">E-mail organisatie metadata (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-metadata:-e-mail): <sch:value-of select="$mdResponsibleParty_Mail"/>
      </sch:report>
      <sch:assert id="Metadata datum (ISO nr. 9)" test="((number(substring(substring-before($dateStamp,'-'),1,4)) &gt; 1000 ))">Metadata datum (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#metadatadatum) ontbreekt of heeft het verkeerde formaat (YYYY-MM-DD)</sch:assert>
      <sch:report id="Metadata datum (ISO nr. 9) info" test="$dateStamp">Metadata datum (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#metadatadatum): <sch:value-of select="$dateStamp"/>
      </sch:report>
      <sch:assert id="Metadatastandaard naam (ISO nr. 10)" test="contains($metadataStandardName, 'ISO 19119')">Metadatastandaard naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#metadata-standaard-naam) is niet correct ingevuld, Metadatastandaard naam dient de waarde 'ISO 19119' te hebben</sch:assert>
      <sch:report id="Metadatastandaard naam (ISO nr. 10) info" test="$metadataStandardName">Metadatastandaard naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#metadata-standaard-naam): <sch:value-of select="$metadataStandardName"/>
      </sch:report>
      <sch:assert id="Versie metadatastandaard  (ISO nr. 11)" test="contains($metadataStandardVersion, 'NEDERLANDS METADATA PROFIEL OP ISO 19119 VOOR SERVICES 2.0')">Versie metadatastandaard (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#metadatastandaard-versie) is niet correct ingevuld, Metadatastandaard versie dient de waarde 'Nederlands metadata profiel op ISO 19119 voor services 2.0' te bevatten. Opgegeven versie: <sch:value-of select="$metadataStandardVersion"/></sch:assert>
      <sch:report id="Versie metadatastandaard  (ISO nr. 11) info" test="contains($metadataStandardVersion, 'NEDERLANDS METADATA PROFIEL OP ISO 19119 VOOR SERVICES 2.0')">Versie metadatastandaard (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#metadatastandaard-versie): <sch:value-of select="$metadataStandardVersion"/>
      </sch:report>
      ...
      <!-- Tests of een waarde of label is opgegeven
            ...
            Voor INSPIRE zijn Anchors verplicht
            -->
      <sch:let name="otherConstraint1" value="normalize-space(gmd:identificationInfo/*/gmd:resourceConstraints[2]/gmd:MD_LegalConstraints/gmd:otherConstraints[1][gmx:Anchor/@xlink:href]/*)"/>
      <sch:let name="otherConstraint2" value="normalize-space(gmd:identificationInfo/*/gmd:resourceConstraints[2]/gmd:MD_LegalConstraints/gmd:otherConstraints[2][gmx:Anchor/@xlink:href]/*)"/>
      ...
      <sch:assert id="Service titel (ISO nr. 360)" test="$serviceTitle">Service titel (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#titel-van-de-bron) ontbreekt</sch:assert>
      <sch:report id="Service titel (ISO nr. 360) info" test="$serviceTitle">Service titel (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#titel-van-de-bron): <sch:value-of select="$serviceTitle"/>
      </sch:report>
      <sch:assert id="Datum van de bron (ISO nr. 394)" test="($publicationDate or $creationDate or $revisionDate or $begin)">Datum van de bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#datum-van-de-bron) ontbreekt of heeft het verkeerde formaat (YYYY-MM-DD)</sch:assert>
      <sch:report id="Datum van de bron (ISO nr. 394) info" test="($publicationDate or $creationDate or $revisionDate or $begin)">Tenminste 1 Datum van de bron  (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#datum-van-de-bron) is gevonden
      </sch:report>
      <!-- https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#samenvatting -->
      <sch:assert id="Samenvatting (ISO nr. 25)" test="$abstract">Samenvatting (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#samenvatting) ontbreekt</sch:assert>
      <sch:report id="Samenvatting (ISO nr. 25) info" test="$abstract">Samenvatting (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#samenvatting): <sch:value-of select="$abstract"/>
      </sch:report>

      <!-- https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-bron -->
      <sch:assert id="Verantwoordelijke organisatie bron (ISO nr. 376)" test="$responsibleParty_OrganisationString or $responsibleParty_OrganisationURI">Verantwoordelijke organisatie bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-bron) ontbreekt</sch:assert>
      ...
      <sch:assert id="Rol verantwoordelijke organisatie bron (ISO nr. 379)" test="$responsibleParty_Role">Rol verantwoordelijke organisatie bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-bron:-rol) ontbreekt of heeft een verkeerde waarde</sch:assert>
      <sch:report id="Rol verantwoordelijke organisatie bron (ISO nr. 379) info" test="$responsibleParty_Role">Rol verantwoordelijke organisatie bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-bron:-rol) voldoet
      </sch:report>
      <sch:assert id="E-mail verantwoordelijke organisatie bron (ISO nr. 386)" test="$responsibleParty_Mail">E-mail verantwoordelijke organisatie bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-bron-email) ontbreekt</sch:assert>
      <sch:report id="E-mail verantwoordelijke organisatie bron (ISO nr. 386) info" test="$responsibleParty_Mail">E-mail verantwoordelijke organisatie bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-bron-email): <sch:value-of select="$responsibleParty_Mail"/>
      </sch:report>

      <sch:assert id="Trefwoorden (ISO nr. 53)" test="$keyword">Trefwoorden (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#trefwoord) ontbreken</sch:assert>
      <sch:report id="Trefwoorden (ISO nr. 53) info" test="$keyword">Tenminste 1 trefwoord (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#trefwoord) is gevonden (<sch:value-of select="$keyword"/>)
      </sch:report>
      ...
      <!-- alleen INSPIRE -->
      <!-- INSPIRE keyword aanwezig voor service categorie https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#trefwoord -->
      ...
      <sch:assert id="Gebruiksbeperkingen (ISO nr. 68)" test="$useLimitation">Gebruiksbeperkingen (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#gebruiksbeperkingen) ontbreken</sch:assert>
      <sch:report id="Gebruiksbeperkingen (ISO nr. 68) info" test="$useLimitation">Gebruiksbeperkingen (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#gebruiksbeperkingen): <sch:value-of select="$useLimitation"/>
      </sch:report>
      <sch:assert id="Overige beperkingen 1 Anchor URI aanwezig" test="$otherConstraintURI1 and $otherConstraintURI1/@xlink:href">Overige beperkingen eerste element: de URI (xlink:href) dient ingevuld te zijn</sch:assert>
      <sch:assert id="Overige beperkingen 2 Anchor URI aanwezig" test="$otherConstraintURI2 and $otherConstraintURI2/@xlink:href">Overige beperkingen tweede element: de URI (xlink:href) dient ingevuld te zijn</sch:assert>
      ...
      <!-- Nota bene: voor INSPIRE moeten otherCosntraints altijd aanweizg zijn, omdat accessConstraints 'otherrestrictions' moet zijn  -->
      <sch:assert id="Overige beperkingen (ISO nr 72)" test="($accessConstraints_value = 'otherRestrictions' and $otherConstraint1 and $otherConstraint2)">Het element overige beperkingen (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#overige-beperkingen) dient twee maal binnen dezelfde toegangsrestricties voor te komen</sch:assert>

      <sch:report id="Overige beperkingen (ISO nr 72) 1 info" test="$otherConstraint1">Overige beperkingen (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#overige-beperkingen) 1: <sch:value-of select="$otherConstraint1"/>
      </sch:report>
      <sch:report id="Overige beperkingen (ISO nr 72) 2 info" test="$otherConstraint2">Overige beperkingen (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#overige-beperkingen) 2: <sch:value-of select="$otherConstraint2"/>
      </sch:report>

      <sch:report id="(Juridische) toegangsrestricties (ISO nr. 70) info"  test="$accessConstraints_value">(Juridische) toegangsrestricties (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#juridische-toegangsrestricties) aanwezig: <sch:value-of select="$accessConstraints_value"/>
      </sch:report>
      ...
      <!-- operationName -->
      <!-- TODO: is alleen verplicht als er een coupled resource is? -->
      <sch:assert id="Operatie naam" test="$operationName">Operatie naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#operatie-naam) ontbreekt of heeft de verkeerde waarde.</sch:assert>
      ...
      <!-- TODO: is alleen verplicht als er een coupled resource is? -->
      <sch:assert id="Connectie URL" test="$connectPointString">De connectie URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#connectie-url) ontbreekt of heeft de verkeerde waarde </sch:assert>
      <sch:report id="Connectie URL info" test="$connectPointString">Connectie URL: <sch:value-of select="$connectPointString"/></sch:report>

      <!-- resourceLocator -->
      <!-- TODO: Thijs: check of deze assertions nog steeds nodig / geldig zijn. Eventueel herschrijven, voor de leesbaarheid? -->
      <sch:assert id="URL en connectpoint Linkage 1" test="not((not($connectPoint) and not($resourceLocator)) and not($resourceLocatorString=$connectPointString))">URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#url) heeft niet dezelfde waarde als de connectie URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#connectie-url)</sch:assert>
      <sch:assert id="URL en connectpoint Linkage 2" test="not(($connectPoint and not($resourceLocator)) and not($resourceLocatorString=$connectPoint))">URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#url) heeft niet dezelfde waarde als de connectie URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#connectie-url)</sch:assert>
      <sch:assert id="URL en connectpoint Linkage 3" test="not(($resourceLocator and not($connectPoint)) and not($resourceLocator=$connectPointString))">URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#url) heeft niet dezelfde waarde als de connectie URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#connectie-url)</sch:assert>
      <sch:assert id="URL en connectpoint Linkage 4" test="not(($connectPoint and $resourceLocator) and not($resourceLocator=$connectPoint))">URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#url) heeft niet dezelfde waarde als de connectie URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#connectie-url)</sch:assert>
      ...
      <sch:report id="URL info" test="$resourceLocatorString">URL: <sch:value-of select="$resourceLocatorString"/>
      </sch:report>

      <!-- protocol: https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#protocol -->
      <sch:assert id="Protocol (ISO nr. 398)" test="not($resourceLocatorString) or ($resourceLocatorString and $transferOptions_Protocol)">Protocol (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#protocol) is verplicht als URL is ingevuld.</sch:assert>
      <sch:report id="Protocol (ISO nr. 398) info" test="$transferOptions_Protocol">Protocol (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#protocol): <sch:value-of select="normalize-space(gmd:identificationInfo[1]/*/gmd:transferOptions[1]/*/gmd:onLine/*/gmd:protocol/*/text())"/>
      </sch:report>
      ...
      <!-- service type -->
      <sch:assert id="Service type" test="$serviceType">Service type (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#service-type) ontbreekt of heeft de verkeerde waarde, gebruik view of download voor services die aan betreffende specificaties van INSPIRE voldoen, in andere gevallen de waarde other.</sch:assert>
      ...
      <sch:report id="Beschrijving info" test="$transferOptions_Description_Value">Service type: <sch:value-of select="$transferOptions_Description_Value"/></sch:report>
      <sch:assert id="Resource locator URL getCapabilities" test="not($conformity_Spec_Title_SDS_Exsists) or ($conformity_Spec_Title_SDS_Exsists and contains(translate($resourceLocatorString, $lowercase, $uppercase),'GETCAPABILITIES'))">URL naar de service moet een getCapabilities request bevatten</sch:assert>
      ...
      <sch:assert id="Minimum x-coordinaat (ISO nr. 344)"  test="(-180.00 &lt; $west) and ( $west &lt; 180.00) or ( $west = 0.00 ) or ( $west = -180.00 ) or ( $west = 180.00 )">Minimum x-coördinaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#omgrenzende-rechthoek) ontbreekt of heeft een verkeerde waarde</sch:assert>
      <sch:report id="Minimum x-coordinaat (ISO nr. 344) info" test="(-180.00 &lt; $west) and ( $west &lt; 180.00) or ( $west = 0.00 ) or ( $west = -180.00 ) or ( $west = 180.00 )">Minimum x-coördinaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#omgrenzende-rechthoek): <sch:value-of select="$west"/>
      </sch:report>
      <sch:assert id="Maximum x-coordinaat (ISO nr. 345)"  test="(-180.00 &lt; $east) and ($east &lt; 180.00) or ( $east = 0.00 ) or ( $east = -180.00 ) or ( $east = 180.00 )">Maximum x-coördinaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#omgrenzende-rechthoek) ontbreekt of heeft een verkeerde waarde</sch:assert>
      <sch:report id="Maximum x-coordinaat (ISO nr. 345) info"  test="(-180.00 &lt; $east) and ($east &lt; 180.00) or ( $east = 0.00 ) or ( $east = -180.00 ) or ( $east = 180.00 )">Maximum x-coördinaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#omgrenzende-rechthoek): <sch:value-of select="$east"/>
      </sch:report>
      <sch:assert id="Minimum y-coordinaat (ISO nr. 346)" test="(-90.00 &lt; $south) and ($south &lt; $north) or (-90.00 = $south) or ($south = $north)">Minimum y-coördinaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#omgrenzende-rechthoek) ontbreekt of heeft een verkeerde waarde</sch:assert>
      <sch:report id="Minimum y-coordinaat (ISO nr. 346) info" test="(-90.00 &lt; $south) and ($south &lt; $north) or (-90.00 = $south) or ($south = $north)">Minimum y-coördinaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#omgrenzende-rechthoek): <sch:value-of select="$south"/>
      </sch:report>
      <sch:assert id="Maximum y-coordinaat (ISO nr. 347)" test="($south &lt; $north) and ($north &lt; 90.00) or ($south = $north) or ($north = 90.00)">Maximum y-coördinaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#omgrenzende-rechthoek) ontbreekt of heeft een verkeerde waarde</sch:assert>
      <sch:report id="Maximum y-coordinaat (ISO nr. 347) info" test="($south &lt; $north) and ($north &lt; 90.00) or ($south = $north) or ($north = 90.00)">Maximum y-coördinaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#omgrenzende-rechthoek): <sch:value-of select="$north"/>
      </sch:report>
      ...
      <!-- rules and assertions -->
      <sch:assert id="Niveau kwaliteitsbeschrijving (ISO nr.139)" test="$level">Niveau kwaliteitsbeschrijving (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#niveau-kwaliteitsbeschrijving) ontbreekt of heeft een verkeerde waarde. Alleen 'service' is toegestaan</sch:assert>
      <sch:report id="Niveau kwaliteitsbeschrijving (ISO nr.139) info" test="$level">Niveau kwaliteitsbeschrijving (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#niveau-kwaliteitsbeschrijving): <sch:value-of select="$level"/>
      </sch:report>

      <sch:assert id="Niveau kwaliteitsbeschrijving naam" test="$levelDescription">Niveau kwaliteitsbeschrijving naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#niveau-kwaliteitsbeschrijving-naam) ontbreekt of heeft een verkeerde waarde. Alleen 'service' is toegestaan</sch:assert>
      <sch:report id="Niveau kwaliteitsbeschrijving naam info" test="$levelDescription">Niveau kwaliteitsbeschrijving naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#niveau-kwaliteitsbeschrijving-naam): <sch:value-of select="$level"/>
      </sch:report>

      <!--qos criteria: for all INSPIRE services, except invocable   -->
      <!-- TODO: test case -->
      <!-- details van de qos criteria worden in een aparte rule getest -->
      <sch:assert id="Criteria kwaliteit van de service" test="$conformity_Spec_Title_SDS_Invoc or $qos_criteria">Criteria van kwaliteit van de service (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria) ontbreken</sch:assert>
    ...
    <sch:rule id="Conformiteit specificaties" context="//gmd:MD_Metadata/gmd:dataQualityInfo[1]/gmd:DQ_DataQuality/gmd:report/gmd:DQ_DomainConsistency/gmd:result/gmd:DQ_ConformanceResult">
      ...
      <sch:let name="conformity_Spec_Title_SDS_Invoc" value="$conformity_SpecTitle='invocable'"/>
      <sch:let name="conformity_Spec_Title_SDS_Interop" value="$conformity_SpecTitle='interoperable'"/>
      <sch:let name="conformity_Spec_Title_SDS_Harmo" value="$conformity_SpecTitle='harmonised'"/>
      <sch:let name="conformity_Spec_Title_SDS" value="normalize-space($conformity_SpecTitle) = 'VERORDENING (EU) Nr. 1089/2010 VAN DE COMMISSIE van 23 november 2010 ter uitvoering van Richtlijn 2007/2/EG van het Europees Parlement en de Raad betreffende de interoperabiliteit van verzamelingen ruimtelijke gegevens en van diensten met betrekking tot ruimtelijke gegevens'"/>
      <sch:let name="conformity_Spec_Title_NS" value="normalize-space($conformity_SpecTitle) = 'VERORDENING (EG) Nr. 976/2009 VAN DE COMMISSIE van 19 oktober 2009 tot uitvoering van Richtlijn 2007/2/EG van het Europees Parlement en de Raad wat betreft de netwerkdiensten'"/>

      <sch:let name="conformity_Spec_Title_SDS_Invoc_URI" value="normalize-space(gmd:specification/gmd:CI_Citation/gmd:title/gmx:Anchor[@xlink:href='http://inspire.ec.europa.eu/id/ats/metadata/2.0/sds-invocable'])"/>
      <sch:let name="conformity_Spec_Title_SDS_Interop_URI" value="normalize-space(gmd:specification/gmd:CI_Citation/gmd:title/gmx:Anchor[@xlink:href='http://inspire.ec.europa.eu/id/ats/metadata/2.0/sds-interoperable'])"/>
      <sch:let name="conformity_Spec_Title_SDS_Harmo_URI" value="normalize-space(gmd:specification/gmd:CI_Citation/gmd:title/gmx:Anchor[@xlink:href='http://inspire.ec.europa.eu/id/ats/metadata/2.0/sds-harmonised'])"/>
      ...
      <sch:assert id="Verklaring (ISO nr. 131)" test="not($conformity_Explanation) or ($conformity_Explanation and $conformity_SpecTitle)">Verklaring (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verklaring) hoort leeg te zijn als geen specificatie is opgegeven</sch:assert>

      <!-- Thijs: TODO: testen of onderstaande werkt -->
      <!-- https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#specificatie  -->
      <sch:assert id="INSPIRE SDS categorie van de service via de URI" test="not($conformity_Spec_Title_SDS) or (($conformity_Spec_Title_SDS_Harmo and $conformity_Spec_Title_SDS_Harmo_URI) or ($conformity_Spec_Title_SDS_Invoc_URI and $conformity_Spec_Title_SDS_Invoc) or ($conformity_Spec_Title_SDS_Interop_URI and $conformity_Spec_Title_SDS_Interop))">Service categorie van een INSPIRE Spatial Data Service moet opgegeven zijn met een Anchor en waarde uit de codelijst INSPIRE serviceCategorie (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#codelijst-INSPIRE-serviceCategorie)</sch:assert>

      <sch:assert id="Datum (ISO nr. 394)" test="not($conformity_Date and not($conformity_SpecTitle))">Datum (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#specificatiedatum) hoort leeg te zijn als geen specificatie is opgegeven. </sch:assert>
      <sch:assert id="Datumtype (ISO nr. 395)" test="not($conformity_Datetype and not($conformity_SpecTitle))">Datumtype (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#specificatiedatum-type) hoort leeg te zijn als geen specificatie is opgegeven.</sch:assert>
      <sch:assert id="Conformiteit (ISO nr. 132" test="not($conformity_Pass) or ($conformity_Pass and $conformity_SpecTitle)">Conformiteit (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#conformiteit-indicatie-met-de-specificatie) hoort leeg te zijn als geen specificatie is opgegeven.</sch:assert>

      <sch:report id="Verklaring (ISO nr. 131) info" test="$conformity_Explanation">Verklaring (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verklaring): <sch:value-of select="$conformity_Explanation"/>
      </sch:report>
      <sch:report id="Conformiteitindicatie met de specificatie (ISO nr. 132) info" test="$conformity_Pass">Conformiteitindicatie met de specificatie (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#conformiteit-indicatie-met-de-specificatie): <sch:value-of select="$conformity_Pass"/>
      </sch:report>
      <sch:report id="Specificatie (ISO nr. 360) info" test="$conformity_SpecTitleString or $conformity_SpecTitleURI">Specificatie (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#specificatie): <sch:value-of select="$conformity_SpecTitleString"/><sch:value-of select="$conformity_SpecTitleURI"/>
      </sch:report>
    ...
    <sch:rule id="alle INSPIRE specificaties" context="//gmd:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:report/gmd:DQ_DomainConsistency/gmd:result/gmd:DQ_ConformanceResult/gmd:specification/gmd:CI_Citation">
      ...
      <!--  -->
      <sch:assert id="INSPIRE Specificatie (ISO nr. 360) titel SDS of netwerkdienst" test="$INSPIRE_SDS_Spec_Title_exists or $INSPIRE_network_Spec_Title_exists">Specificatie (ISO nr. 360) heeft geen verwijzingen naar of de verordening voor netwerkdiensten van INSPIRE of een verwijzing naar SDS invocable, interoperable of harmonised. Vul één van deze in.</sch:assert>
      <sch:assert id="INSPIRE Specificatie (ISO nr. 360) titel SDS en netwerkdienst" test="not($INSPIRE_SDS_Spec_Title_exists and $INSPIRE_network_Spec_Title_exists)">Specificatie (ISO nr. 360) verwijzingen moeten opgenomen worden naar of de verordening voor netwerkdiensten of een verwijzing naar SDS invocable, interoperable of harmonised. Niet beide.</sch:assert>
      ...
      <!-- check op codelijst serviceCategorie  -->
    ...
    <!-- Parameter elements:
        ...
        -->
    <sch:rule id="Parameter elementen" context="//gmd:MD_Metadata/gmd:identificationInfo/*/srv:containsOperations/*/srv:parameters/srv:SV_Parameter">
      ...
      <sch:assert id="Parameter naam" test="$parameterName">Parameter naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#parameter-naam) is niet beschreven</sch:assert>
      <sch:assert id="Parameter optionaliteit" test="$parameterOptionality">Parameter optionaliteit (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#parameter-optionaliteit) is niet beschreven</sch:assert>
      <sch:assert id="Parameter herhaalbaarheid" test="$parameterRepeatability">Parameter herhaalbaarheid (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#parameter-herhaalbaarheid) is niet beschreven</sch:assert>
    </sch:rule>
    ...
    <!-- TODO: assertion om te checken dat de criteria zijn opgenomen? als invocable, harmonised of network service moet //gmd:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:report/gmd:DQ_ConceptualConsistency aanwezig zijn  -->
    <sch:rule id="INSPIRE interoperabele service - service kwaliteit" context="//gmd:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:report/gmd:DQ_ConceptualConsistency">
      <!-- anchor verplicht -->
      ...
      <sch:report id="INSPIRE interoperabele service kwaliteit (ISO nr. 100 ) availability info" test="$all_quality_measures_join">Aanwezige kwaliteits meetingen: <sch:value-of select="$all_quality_measures_join"/>
      </sch:report>

      <sch:assert id="INSPIRE interoperabele service kwaliteit identificatie (ISO nr. 101 )" test="not($quality_name_Of_Measure) or ($quality_name_Of_Measure and $quality_measure_Identification)">Identificatie van service kwaliteitsmeeting (ISO nr. 101) is verplicht als een meeting is opgegeven.</sch:assert>
      <sch:assert id="INSPIRE interoperabele service kwaliteit beschrijving (ISO nr. 102 )" test="not($quality_name_Of_Measure) or ($quality_name_Of_Measure and $quality_measure_Description)">Beschrijving van service kwaliteit (ISO nr. 102) is verplicht als een meeting is opgegeven.</sch:assert>
      <sch:assert id="INSPIRE interoperabele service kwaliteit resultaat (ISO nr. 107 )" test="not($quality_name_Of_Measure) or ($quality_name_Of_Measure and $quality_result)">Resultaat van service kwaliteit (ISO nr. 107) is verplicht als een meeting is opgegeven.</sch:assert>
      <sch:assert id="INSPIRE interoperabele service kwaliteit eenheid waarde (ISO nr. 107 )" test="not($quality_name_Of_Measure) or ($quality_name_Of_Measure and ($quality_value_unit or $quality_value_unit_Reason))">Voor resultaat van service kwaliteit (ISO nr. 107) is ook een eenheid verplicht als een meeting is opgegeven.</sch:assert>


      <!-- TODO: test file -->
      <!-- TODO: conditioneel: verplicht voor INSPIRE interoperabele services -->
      <sch:assert id="INSPIRE interoperabele service kwaliteit beschikbaarheid" test="$quality_name_Of_Measure_Availability">De beschikbaarheid van de service is niet beschreven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria)</sch:assert>
      <sch:assert id="INSPIRE interoperabele service kwaliteit performance" test="$quality_name_Of_Measure_Performance">De performance van de service is niet beschreven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria)</sch:assert>
      <sch:assert id="INSPIRE interoperabele service kwaliteit capaciteit" test="$quality_name_Of_Measure_Capacity">De capaciteit van de service is niet beschreven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria)</sch:assert>

      <!-- TODO: conditioneel: verplicht voor INSPIRE interoperabele services -->
      <sch:assert id="INSPIRE interoperabele service kwaliteit beschikbaarheid" test="$quality_measure_Description_Availability">De criterium beschrijving van de beschikbaarheid van de service is niet opgegeven  (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-beschrijving)</sch:assert>
      <sch:assert id="INSPIRE interoperabele service kwaliteit performance" test="$quality_measure_Description_Performance">De criterium beschrijving van de performance van de service is niet opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-beschrijving)</sch:assert>
      <sch:assert id="INSPIRE interoperabele service kwaliteit capaciteit" test="$quality_measure_Description_Capacity">De criterium beschrijving van de capaciteit van de service is niet opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-beschrijving)</sch:assert>


      <!-- TODO: conditioneel: verplicht voor INSPIRE interoperabele services -->
      <sch:assert id="INSPIRE interoperabele service kwaliteit beschikbaarheid type waarde" test="$quality_value_unit_Availability='urn:ogc:def:uom:OGC::percent'">Het type waarde voor de beschikbaarheid van de service is niet correct opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-type-waarde). Het moet zijn: 'urn:ogc:def:uom:OGC::percent', maar '<sch:value-of select="$quality_value_unit_Availability"/>' is opgegeven.</sch:assert>
      <sch:assert id="INSPIRE interoperabele service kwaliteit performance type waarde" test="$quality_value_unit_Performance=' 	http://www.opengis.net/def/uom/SI/second'">Het type waarde voor de performance van de service is niet correct opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-type-waarde). Het moet zijn: 'http://www.opengis.net/def/uom/SI/second', maar '<sch:value-of select="$quality_value_unit_Performance"/>' is opgegeven.</sch:assert>
      <sch:assert id="INSPIRE interoperabele service kwaliteit capaciteit type waarde" test="$quality_value_unit_Capacity='http://www.opengis.net/def/uom/OGC/1.0/unity'">Het type waarde voor de capaciteit van de service is niet correct opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-type-waarde). Het moet zijn: 'http://www.opengis.net/def/uom/OGC/1.0/unity', maar '<sch:value-of select="$quality_value_unit_Performance"/>' is opgegeven.</sch:assert>

      <!-- TODO: conditioneel: verplicht voor INSPIRE interoperabele services -->
      <sch:assert id="INSPIRE interoperabele service kwaliteit beschikbaarheid waarde" test="$quality_result_Availability">De meetwaarde voor de beschikbaarheid van de service is niet correct opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-waarde).</sch:assert>
      <sch:assert id="INSPIRE interoperabele service kwaliteit performance waarde" test="$quality_result_Performance">De meetwaarde voor de performance van de service is niet correct opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-waarde).</sch:assert>
      <sch:assert id="INSPIRE interoperabele service kwaliteit capaciteit waarde" test="$quality_result_Capacity">De meetwaarde voor de capaciteit van de service is niet correct opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-waarde).</sch:assert>
    ...
    <sch:rule id="Referentiesysteem" context="//gmd:MD_Metadata/gmd:referenceSystemInfo/*">
      ...
      <sch:assert id="Code referentiesysteem (ISO nr. 207)" test="$referenceSystemInfo_CodeString or $referenceSystemInfo_CodeURI">Code referentiesysteem (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#codereferentiesysteem) ontbreekt</sch:assert>
    ...
    <sch:rule id="Thesaurus" context="//gmd:MD_Metadata/gmd:identificationInfo/*/gmd:descriptiveKeywords/*/gmd:thesaurusName/gmd:CI_Citation">
      ...
      <!-- all_thesaurus_Titles: voor INSPIRE in gebruik  -->
      ...
      <sch:report id="INSPIRE Thesaurus title (ISO nr. 360) info" test="$thesaurus_TitleString">Thesaurus title (ISO nr. 360) is: <sch:value-of select="$thesaurus_TitleString"/></sch:report>
      <!-- Eind Thesaurus titel alleen voor INSPIRE-->

      <!-- Als het de GEMET thesaurus is, moet de datum 2008-06-01 zijn https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#thesaurusdatum  -->
      <sch:assert id="Datum INSPIRE Thesaurus is 2008-06-01" test="not($thesaurus_TitleString='GEMET - INSPIRE themes, version 1.0') or ($thesaurus_TitleString='GEMET - INSPIRE themes, version 1.0' and $thesaurus_publicationDateString='2008-06-01')">De INSPIRE Thesaurus heeft niet als publicatie datum 2008-06-01, maar: <sch:value-of select="$thesaurus_publicationDateString"/></sch:assert>
      <!-- TODO: is dit report wel nuttig? -->
      <sch:report id="Datum INSPIRE Thesaurus is 2008-06-01" test="$thesaurus_TitleString and $thesaurus_publicationDateString">Thesaurus <sch:value-of select="$thesaurus_TitleString"/> heeft publicatiedatum <sch:value-of select="$thesaurus_publicationDateString"/></sch:report>
