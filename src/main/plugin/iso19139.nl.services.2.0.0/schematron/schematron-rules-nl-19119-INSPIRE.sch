...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
	...
	<sch:pattern id="Validatie tegen het Nederlands metadata profiel op ISO 19119">
		...
		<sch:let name="conformity_Spec_Title_SDS_Invoc" value="contains(//gmd:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:report/gmd:DQ_DomainConsistency/gmd:result/gmd:DQ_ConformanceResult/gmd:specification/gmd:CI_Citation/gmd:title/gmx:Anchor[@xlink:href='http://inspire.ec.europa.eu/id/ats/metadata/2.0/sds-invocable'],'invocable')"/>
		<sch:let name="conformity_Spec_Title_SDS_Interop" value="contains(//gmd:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:report/gmd:DQ_DomainConsistency/gmd:result/gmd:DQ_ConformanceResult/gmd:specification/gmd:CI_Citation/gmd:title/gmx:Anchor[@xlink:href='http://inspire.ec.europa.eu/id/ats/metadata/2.0/sds-interoperable'],'interoperable')"/>
		<sch:let name="conformity_Spec_Title_SDS_Harmo" value="contains(//gmd:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:report/gmd:DQ_DomainConsistency/gmd:result/gmd:DQ_ConformanceResult/gmd:specification/gmd:CI_Citation/gmd:title/gmx:Anchor[@xlink:href='http://inspire.ec.europa.eu/id/ats/metadata/2.0/sds-harmonised'],'harmonised')"/>
...
-->
		...
		<!-- eind INSPIRE in combi met specificatie INSPIRE -->
			...
			<sch:report id="Versie_metadatastandaard__ISO_nr_11_info" etf_name="Versie metadatastandaard  (ISO nr. 11) info" test="contains($metadataStandardVersion, 'NEDERLANDS METADATA PROFIEL OP ISO 19119 VOOR SERVICES 2.0')">Versie metadatastandaard (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#metadatastandaard-versie): <sch:value-of select="$metadataStandardVersion"/>
			</sch:report>
	...
	https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#samenvatting -->
		...
		<!-- INSPIRE: https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#Codelijst-INSPIRE-LimitationsOnPublicAccess -->
		...
		<!-- INSPIRE in combi met SDS interop INSPIRE -->
			<sch:assert id="Rol_organisatie_SDS_ISO_nr_379" etf_name="Rol organisatie SDS (ISO nr. 379)" test="not($conformity_Spec_Title_SDS_Interop) or ($conformity_Spec_Title_SDS_Interop and contains($responsibleParty_Role, 'custodian'))">Rol organisatie (ISO nr. 379) ontbreekt of heeft een verkeerde waarde, voor INSPIRE interoperable SDS in ieder geval de rol beheerder opnemen</sch:assert>
		...
		<!-- INSPIRE keyword aanwezig voor service categorie https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#trefwoord -->
			<sch:assert id="INSPIRE_Trefwoorden_ISO_nr_53" etf_name="INSPIRE Trefwoorden (ISO nr. 53)" test="$keyword_INSPIRE">Trefwoord (ISO nr. 53) voor INSPIRE servicetype ontbreekt of heeft de verkeerde waarde</sch:assert>
		<!-- eind alleen INSPIRE -->
		...
		<!-- https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#url -->
			...
			<!-- Nieuw, Parameter naam. Zit in een aparte rule https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#parameter-naam  -->
	...
	<!-- eind alleen INSPIRE specificatie in combi met servicetype -->
		<!-- INSPIRE SDS -->
			...
			<!-- Dit is te streng, SDS hoeft geen OGC service met GetCapabilitites te zijn. Dus naar waarschuwingen verplaatst. Lijkt nu niet goed te werken alleen. -->
		<!-- <sch:assert id="Resource_locator_URL_getCapabilities" etf_name="Resource locator URL getCapabilities" test="not($conformity_Spec_Title_SDS_Exsists) or ($conformity_Spec_Title_SDS_Exsists and contains(translate($resourceLocatorString, $lowercase, $uppercase),'GETCAPABILITIES'))">URL naar de service moet een getCapabilities request bevatten</sch:assert> -->
	...
	<!-- eind  INSPIRE	SDS-->
		...
		<!-- Opgave Ine (28 november 2018): altijd checken op omgrenzende rechthoek, ook al is dat conditioneel -->
		...
		<!-- rules and assertions -->
			...
			<sch:assert id="Criteria_kwaliteit_van_de_service" etf_name="Criteria kwaliteit van de service" test="(($conformity_Spec_Title_SDS_Harmo or $conformity_Spec_Title_SDS_Interop) and $qos_criteria) or (not(conformity_Spec_Title_SDS_Interop) and not($conformity_Spec_Title_SDS_Harmo))">Criteria van kwaliteit van de service (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria) ontbreken. Deze zijn verplicht voor een Interoparebele Spatial Data Service en een Harmonised Spatial Data Service.</sch:assert>
		</sch:rule>
		...
		<!-- Specificatie date https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#specificatiedatum	-->
			...
			<sch:let name="conformity_Spec_Title_SDS_Invoc" value="normalize-space(string-join(gmd:specification/gmd:CI_Citation/gmd:title/gmx:Anchor[@xlink:href='http://inspire.ec.europa.eu/id/ats/metadata/2.0/sds-invocable']//text(), ''))='invocable'"/>
			<sch:let name="conformity_Spec_Title_SDS_Interop" value="normalize-space(string-join(gmd:specification/gmd:CI_Citation/gmd:title/gmx:Anchor[@xlink:href='http://inspire.ec.europa.eu/id/ats/metadata/2.0/sds-interoperable']//text(), ''))='interoperable'"/>
			<sch:let name="conformity_Spec_Title_SDS_Harmo" value="normalize-space(string-join(gmd:specification/gmd:CI_Citation/gmd:title/gmx:Anchor[@xlink:href='http://inspire.ec.europa.eu/id/ats/metadata/2.0/sds-harmonised']//text(), ''))='harmonised'"/>
		...
		<!-- als er geen titel is ingevuld, moeten date, datetype explanation en pass leeg zijn -->
			...
			<!--Alegemen referentie naar de verordening of een specifiek type (interoperable, harmonised, invocable) met waarde en URI-->
			<sch:assert id="INSPIRE_SDS_categorie_van_de_service_via_een_URI" etf_name="INSPIRE SDS categorie van de service via een URI" test="not($conformity_Spec_Title_SDS_Harmo_URI or conformity_Spec_Title_SDS_Invoc_URI or conformity_Spec_Title_SDS_Interop_URI) or (($conformity_Spec_Title_SDS_Harmo and $conformity_Spec_Title_SDS_Harmo_URI) or ($conformity_Spec_Title_SDS_Invoc_URI and $conformity_Spec_Title_SDS_Invoc) or ($conformity_Spec_Title_SDS_Interop_URI and $conformity_Spec_Title_SDS_Interop))">Service categorie van een INSPIRE Spatial Data Service moet opgegeven zijn met een Anchor en waarde uit de codelijst INSPIRE serviceCategorie (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#codelijst-INSPIRE-serviceCategorie). Opgegeven categorie: <sch:value-of select="$conformity_SpecTitle"/> en URI: <sch:value-of select="$conformity_SpecTitleURI"/> </sch:assert>
		...
		<!-- -->
			<!-- <sch:assert id="INSPIRE_Specificatie_ISO_nr_360_titel_interoperabiliteit" etf_name="INSPIRE Specificatie (ISO nr. 360) titel interoperabiliteit" test="$INSPIRE_interop_Spec_Title_exists">Specificatie (ISO nr. 360) ontbreekt of heeft de verkeerde waarde. Het is voor een SDS noodzakelijk te verwijzen naar de VERORDENING (EU) Nr. 1089/2010 VAN DE COMMISSIE van 23 november 2010 ter uitvoering van Richtlijn 2007/2/EG van het Europees Parlement en de Raad betreffende de interoperabiliteit van verzamelingen ruimtelijke gegevens en van diensten met betrekking tot ruimtelijke gegevens</sch:assert>
		 -->
		<!-- INSPIRE SDS titel of titel netwerk  moet aanwezig zijn, niet beide-->
		<!--  -->
		<!-- TODO: check opsommingen per servicetype: voor sds: verordening, + tech spec + sds type . Voor netwerk servcie verordening + tech spec -->
			<sch:assert id="INSPIRE_Specificatie_ISO_nr_360_titel_SDS_of_netwerkdienst" etf_name="INSPIRE Specificatie (ISO nr. 360) titel SDS of netwerkdienst" test="$INSPIRE_interop_Spec_Title_exists or $INSPIRE_network_Spec_Title_exists">Specificatie (ISO nr. 360) heeft geen verwijzingen naar of de verordening voor netwerkdiensten van INSPIRE of een verwijzing naar verordening van interoperabiliteit van data en services. Vul één van deze in.</sch:assert>
			<sch:assert id="INSPIRE_Specificatie_ISO_nr_360_titel_SDS_en_netwerkdienst" etf_name="INSPIRE Specificatie (ISO nr. 360) titel SDS en netwerkdienst" test="not($INSPIRE_interop_Spec_Title_exists and $INSPIRE_network_Spec_Title_exists)">Specificatie (ISO nr. 360) verwijzingen moeten opgenomen worden naar of de verordening voor netwerkdiensten of een verwijzing naar SDS invocable, interoperable of harmonised. Niet beide.</sch:assert>

		<!-- eind alleen INSPIRE interoperable titel moet aanwezig zijn-->
			<sch:assert id="INSPIRE_Specificatie_netwerkdienst_en_technischespec" etf_name="INSPIRE Specificatie (ISO nr. 360)  netwerkdienst heeft ook een technische specificatie" test="not($INSPIRE_network_Spec_Title_exists) or ($INSPIRE_network_Spec_Title_exists and count($all_conformity_Spec_Titles) >= 2)">De metadata verwijst naar de verordening voor netwerkdiensten van INSPIRE, maar specificatie (ISO nr. 360) heeft geen verwijzingen naar de technische specificatie. (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#specificatie)</sch:assert>

			<sch:assert id="INSPIRE_Specificatie_sdsdienst_en_specs" etf_name="INSPIRE Specificatie (ISO nr. 360) SDS, categorie en technische specificatie" test="not($INSPIRE_interop_Spec_Title_exists) or ($INSPIRE_interop_Spec_Title_exists and $INSPIRE_SDS_Spec_Title_exists and count($all_conformity_Spec_Titles) >= 3)">De metadata verwijst naar de verordening van interoperabiliteit van data en services (voor SDS), maar specificatie (ISO nr. 360) heeft geen verwijzingen naar de technische specificatie en/of geen verwijzing naar de categorie van de service. (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#specificatie)</sch:assert>
		...
		<sch:rule id="INSPIRE_interoperabele_service_-_service_kwaliteit" etf_name="INSPIRE interoperabele service - service kwaliteit" context="//gmd:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality[gmd:report/gmd:DQ_ConceptualConsistency]">
			...
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_beschikbaarheid" etf_name="INSPIRE interoperabele service kwaliteit beschikbaarheid" test="$quality_name_Of_Measure_Availability">De beschikbaarheid van de service is niet beschreven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria)</sch:assert>
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_performance" etf_name="INSPIRE interoperabele service kwaliteit performance" test="$quality_name_Of_Measure_Performance">De performance van de service is niet beschreven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria)</sch:assert>
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_capaciteit" etf_name="INSPIRE interoperabele service kwaliteit capaciteit" test="$quality_name_Of_Measure_Capacity">De capaciteit van de service is niet beschreven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria)</sch:assert>

			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_beschikbaarheid_beschrijving" etf_name="INSPIRE interoperabele service kwaliteit beschikbaarheid beschrijving" test="$quality_measure_Description_Availability">De criterium beschrijving van de beschikbaarheid van de service is niet opgegeven  (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-beschrijving)</sch:assert>
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_performance_beschrijving" etf_name="INSPIRE interoperabele service kwaliteit performance beschrijving" test="$quality_measure_Description_Performance">De criterium beschrijving van de performance van de service is niet opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-beschrijving)</sch:assert>
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_capaciteit_beschrijving" etf_name="INSPIRE interoperabele service kwaliteit capaciteit beschrijving" test="$quality_measure_Description_Capacity">De criterium beschrijving van de capaciteit van de service is niet opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-beschrijving)</sch:assert>


			<!-- conditioneel: verplicht voor INSPIRE interoperabele services, maar de verplichting loopt via een andere assertion. Onderstaande wordt getest als de QoS zaken aanwezig zijn  -->
			...
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_beschikbaarheid_waarde" etf_name="INSPIRE interoperabele service kwaliteit beschikbaarheid waarde" test="$quality_result_Availability">De meetwaarde voor de beschikbaarheid van de service is niet correct opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-waarde).</sch:assert>
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_performance_waarde" etf_name="INSPIRE interoperabele service kwaliteit performance waarde" test="$quality_result_Performance">De meetwaarde voor de performance van de service is niet correct opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-waarde).</sch:assert>
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_capaciteit_waarde" etf_name="INSPIRE interoperabele service kwaliteit capaciteit waarde" test="$quality_result_Capacity">De meetwaarde voor de capaciteit van de service is niet correct opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-waarde).</sch:assert>
		...
		<!-- eind INSPIRE SDS Referentiesysteem  -->
				...
				<sch:rule id="Thesaurus" etf_name="Thesaurus" context="//gmd:MD_Metadata/gmd:identificationInfo/*/gmd:descriptiveKeywords/*/gmd:thesaurusName/gmd:CI_Citation">
					...
					<sch:assert id="INSPIRE_Thesaurus_title_ISO_nr_360" etf_name="INSPIRE Thesaurus title (ISO nr. 360)" test="$all_thesaurus_Titles[normalize-space(*/text()) = 'GEMET - INSPIRE themes, version 1.0']">Thesaurus title (ISO nr. 360) ontbreekt of heeft de verkeerde waarde. Eén Thesaurus titel dient de waarde 'GEMET - INSPIRE themes, version 1.0 ' te bevatten.</sch:assert>
					 <sch:report id="INSPIRE_Thesaurus_title_ISO_nr_360_info" etf_name="INSPIRE Thesaurus title (ISO nr. 360) info" test="$thesaurus_TitleString">Thesaurus title (ISO nr. 360) is: <sch:value-of select="$thesaurus_TitleString"/></sch:report>
					...
					<sch:assert id="Datum_INSPIRE_Thesaurus_is_2008-06-01" etf_name="Datum INSPIRE Thesaurus is 2008-06-01" test="not($thesaurus_TitleString='GEMET - INSPIRE themes, version 1.0') or ($thesaurus_TitleString='GEMET - INSPIRE themes, version 1.0' and $thesaurus_publicationDateString='2008-06-01')">De INSPIRE Thesaurus heeft niet als publicatie datum 2008-06-01, maar: <sch:value-of select="$thesaurus_publicationDateString"/></sch:assert>
					<sch:report id="Datum_INSPIRE_Thesaurus_is_2008-06-01" etf_name="Datum INSPIRE Thesaurus is 2008-06-01" test="$thesaurus_TitleString and $thesaurus_publicationDateString">Thesaurus <sch:value-of select="$thesaurus_TitleString"/> heeft publicatiedatum <sch:value-of select="$thesaurus_publicationDateString"/></sch:report>
...
Deze keywords komen niet overeen met GEMET- INSPIRE themes thesaurus. gevonden keywords: <sch:value-of select="."/></sch:assert>
	...
	<sch:rule id="Waarschuwingen_-_Algemene_metadata_regels" etf_name="Waarschuwingen - Algemene metadata regels" context="/gmd:MD_Metadata">
		...
		<sch:let name="conformity_Spec_Title_Network_Exsists" value="contains($conformity_Spec_Title_All,'VERORDENING (EG) Nr. 976/2009 VAN DE COMMISSIE van 19 oktober 2009 tot uitvoering van Richtlijn 2007/2/EG van het Europees Parlement en de Raad wat betreft de netwerkdiensten')"/>
			...
			<sch:assert id="Resource_locator_URL_getCapabilities" etf_name="Resource locator URL getCapabilities" test="not($conformity_Spec_Title_SDS_Exsists) or ($conformity_Spec_Title_SDS_Exsists and contains(translate($resourceLocatorString, $lowercase, $uppercase),'GETCAPABILITIES'))">URL naar de service moet een getCapabilities request bevatten. De opgegeven URL: <sch:value-of select="$resourceLocatorString"/></sch:assert>
