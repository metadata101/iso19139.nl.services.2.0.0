...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
	...
	<sch:pattern id="Validatie_tegen_het_Nederlands_metadata_profiel_op_ISO_19119">
...
-->
		...
		<!-- rules and assertions -->
			<sch:assert id="Metadata_ID__ISO_nr._2_" test="$fileIdentifier">Metadata ID (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#metadata-unieke-identifier) ontbreekt of heeft een verkeerde waarde.</sch:assert>
			<sch:report id="Metadata_ID__ISO_nr._2__info" test="$fileIdentifier">Metadata ID: <sch:value-of select="$fileIdentifier"/>
			</sch:report>
			<sch:assert id="De_metadata_taal__ISO_nr._3_" test="$mdLanguage">De metadata taal (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#taal-van-de-metadata) ontbreekt of heeft een verkeerde waarde. Dit hoort een waarde en verwijzing naar de codelijst te zijn.</sch:assert>
			<sch:report id="De_metadata_taal__ISO_nr._3__info" test="$mdLanguage">Metadata taal (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#taal-van-de-metadata) voldoet
			</sch:report>
			<sch:assert id="Hierarchieniveau__ISO_nr._6_" test="$hierarchyLevel">Hierarchieniveau (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#hi%C3%ABrarchieniveau) ontbreekt of heeft een verkeerde waarde</sch:assert>
			<sch:report id="Hierarchieniveau__ISO_nr._6_info" test="$hierarchyLevel">Hierarchieniveau (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#hi%C3%ABrarchieniveau) voldoet
			</sch:report>
			<sch:assert id="Hierarchieniveau_naam" test="$hierarchyLevelName">Hierarchieniveau naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#hi%C3%ABrarchieniveaunaam) ontbreekt of heeft een verkeerde waarde</sch:assert>
			<sch:report id="Hierarchieniveau_naam_info" test="$hierarchyLevelName">Hierarchieniveau naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#hi%C3%ABrarchieniveaunaam) voldoet
			</sch:report>

			<sch:assert id="Naam_organisatie_metadata__ISO_nr._376_" test="$mdResponsibleParty_OrganisationString or $mdResponsibleParty_OrganisationURI">Naam organisatie metadata (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-metadata) ontbreekt</sch:assert>
			...
			<sch:assert id="Rol_organisatie_metadata__ISO_nr._379_" test="$mdResponsibleParty_Role">Rol organisatie metadata (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-metadata:-rol) ontbreekt of heeft een verkeerde waarde</sch:assert>
			<sch:report id="Rol_organisatie_metadata__ISO_nr._379__info" test="$mdResponsibleParty_Role">Rol organisatie metadata (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-metadata:-rol) <sch:value-of select="$mdResponsibleParty_Role"/>
			</sch:report>

		<!-- INSPIRE in combi met specificatie INSPIRE -->
			<sch:assert id="INSPIRE_Rol_organisatie_metadata__ISO_nr._379_" test="not($conformity_Spec_Title_Interoperability_Exsists) or ($conformity_Spec_Title_Interoperability_Exsists and $mdResponsibleParty_Role_INSPIRE)">Rol organisatie metadata (ISO nr. 379) ontbreekt of heeft een verkeerde waarde, deze dient voor INSPIRE contactpunt te zijn</sch:assert>

		<!-- eind INSPIRE in combi met specificatie INSPIRE -->
			<sch:assert id="E-mail_organisatie_metadata__ISO_nr._386_" test="$mdResponsibleParty_Mail">E-mail organisatie metadata (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-metadata:-e-mail) ontbreekt</sch:assert>
			<sch:report id="E-mail_organisatie_metadata_ISO_nr._386__info" test="$mdResponsibleParty_Mail">E-mail organisatie metadata (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-metadata:-e-mail): <sch:value-of select="$mdResponsibleParty_Mail"/>
			</sch:report>
			<sch:assert id="Metadata_datum__ISO_nr._9_" test="((number(substring(substring-before($dateStamp,'-'),1,4)) &gt; 1000 ))">Metadata datum (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#metadatadatum) ontbreekt of heeft het verkeerde formaat (YYYY-MM-DD)</sch:assert>
			<sch:report id="Metadata_datum__ISO_nr._9__info" test="$dateStamp">Metadata datum (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#metadatadatum): <sch:value-of select="$dateStamp"/>
			</sch:report>
			<sch:assert id="Metadatastandaard_naam__ISO_nr._10_" test="contains($metadataStandardName, 'ISO 19119')">Metadatastandaard naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#metadata-standaard-naam) is niet correct ingevuld, Metadatastandaard naam dient de waarde 'ISO 19119' te hebben</sch:assert>
			<sch:report id="Metadatastandaard_naam__ISO_nr._10__info" test="$metadataStandardName">Metadatastandaard naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#metadata-standaard-naam): <sch:value-of select="$metadataStandardName"/>
			</sch:report>
			<sch:assert id="Versie_metadatastandaard___ISO_nr._11_" test="contains($metadataStandardVersion, 'PROFIEL OP ISO 19119')">Versie metadatastandaard (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#metadatastandaard-versie) is niet correct ingevuld, Metadatastandaard versie dient de waarde 'Nederlands metadata profiel op ISO 19119 voor services 2.0' te bevatten</sch:assert>
			<sch:report id="Versie_metadatastandaard___ISO_nr._11___info" test="contains($metadataStandardVersion, 'PROFIEL OP ISO 19119')">Versie metadatastandaard (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#metadatastandaard-versie): <sch:value-of select="$metadataStandardVersion"/>
			</sch:report>

			<sch:assert id="Metadata_karakterset_ISO_nr._4_" test="not($metadataCharacterset) or $metadataCharacterset_value">Metadata karakterset (ISO nr. 4) ontbreekt of heeft een verkeerde waarde</sch:assert>
			<sch:report id="Metadata_karakterset_ISO_nr._4__info" test="not($metadataCharacterset) or $metadataCharacterset_value">Metadata karakterset (ISO nr. 4) voldoet</sch:report>
	...
	https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#samenvatting -->
		...
		<!-- Als  de GEMET INSPIRE themes thesaurus voorkomt, is verwijzing naar inspire specificatie verplicht -->
			...
			<sch:assert id="INSPIRE_Specificaties__ISO_nr._360_" test="not($thesaurus_INSPIRE_Exsists) or ($thesaurus_INSPIRE_Exsists and $conformity_Spec_Title_Interoperability_Exsists)">Specificatie (ISO nr. 360) mist de verplichte waarden voor INSPIRE services, Als dit geen INSPIRE service is verwijder dan de thesaurus GEMET -INSPIRE themes, voor INSPIRE service in specificatie opnemen; VERORDENING (EU) Nr. 1089/2010 VAN DE COMMISSIE van 23 november 2010 ter uitvoering van Richtlijn 2007/2/EG van het Europees Parlement en de Raad betreffende de interoperabiliteit van verzamelingen ruimtelijke gegevens en van diensten met betrekking tot ruimtelijke gegevens</sch:assert>
		...
		<!-- Gebruiksbeperkingen, https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#gebruiksbeperkingen -->
			<sch:let name="useLimitation" value="normalize-space(gmd:identificationInfo/*/gmd:resourceConstraints[1]/gmd:MD_Constraints/gmd:useLimitation[1]/gco:CharacterString)"/>

			<!-- Tests of een waarde of label is opgegeven
			Bij Anchors: of het element ook een xlink:href heeft
			-->
			<sch:let name="otherConstraint1" value="normalize-space(gmd:identificationInfo/*/gmd:resourceConstraints[2]/gmd:MD_LegalConstraints/gmd:otherConstraints[1][gco:CharacterString or gmx:Anchor/@xlink:href]/*)"/>
			<sch:let name="otherConstraint2" value="normalize-space(gmd:identificationInfo/*/gmd:resourceConstraints[2]/gmd:MD_LegalConstraints/gmd:otherConstraints[2][gco:CharacterString or gmx:Anchor/@xlink:href]/*)"/>
			...
			<!--	<sch:let name="classification_value" value="gmd:identificationInfo/*/gmd:resourceConstraints/gmd:MD_SecurityConstraints/gmd:classification/*[@codeListValue = 'unclassified' or @codeListValue = 'restricted' or @codeListValue = 'confidential' or @codeListValue = 'secret' or @codeListValue = 'topSecret']"/>
		-->
		...
		<!-- rules and assertions -->
			...
			<sch:assert id="Service_titel__ISO_nr._360_" test="$serviceTitle">Service titel (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#titel-van-de-bron) ontbreekt</sch:assert>
			<sch:report id="Service_titel__ISO_nr._360__info" test="$serviceTitle">Service titel (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#titel-van-de-bron): <sch:value-of select="$serviceTitle"/>
		    	</sch:report>
			<sch:assert id="Datum_van_de_bron__ISO_nr._394_" test="($publicationDate or $creationDate or $revisionDate or $begin)">Datum van de bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#datum-van-de-bron) ontbreekt of heeft het verkeerde formaat (YYYY-MM-DD)</sch:assert>
			<sch:report id="Datum_van_de_bron__ISO_nr._394__info" test="($publicationDate or $creationDate or $revisionDate or $begin)">Tenminste 1 Datum van de bron  (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#datum-van-de-bron) is gevonden
		    	</sch:report>
			<!-- https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#samenvatting -->
			<sch:assert id="Samenvatting__ISO_nr._25_" test="$abstract">Samenvatting (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#samenvatting) ontbreekt</sch:assert>
			<sch:report id="Samenvatting__ISO_nr._25__info" test="$abstract">Samenvatting (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#samenvatting): <sch:value-of select="$abstract"/>
		    	</sch:report>

			<!-- https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-bron -->
			<sch:assert id="Verantwoordelijke_organisatie_bron__ISO_nr_376_" test="$responsibleParty_OrganisationString or $responsibleParty_OrganisationURI">Verantwoordelijke organisatie bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-bron) ontbreekt</sch:assert>
			...
			<sch:assert id="Rol_verantwoordelijke_organisatie_bron__ISO_nr._379_" test="$responsibleParty_Role">Rol verantwoordelijke organisatie bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-bron:-rol) ontbreekt of heeft een verkeerde waarde</sch:assert>
			<sch:report id="Rol_verantwoordelijke_organisatie_bron__ISO_nr._379__info" test="$responsibleParty_Role">Rol verantwoordelijke organisatie bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-bron:-rol) voldoet
			</sch:report>
			<sch:assert id="E-mail_verantwoordelijke_organisatie_bron__ISO_nr._386_" test="$responsibleParty_Mail">E-mail verantwoordelijke organisatie bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-bron-email) ontbreekt</sch:assert>
			<sch:report id="E-mail_verantwoordelijke_organisatie_bron__ISO_nr._386__info" test="$responsibleParty_Mail">E-mail verantwoordelijke organisatie bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verantwoordelijke-organisatie-bron-email): <sch:value-of select="$responsibleParty_Mail"/>
			</sch:report>

			<sch:assert id="Trefwoorden__ISO_nr._53_" test="$keyword">Trefwoorden (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#trefwoord) ontbreken</sch:assert>
			<sch:report id="Trefwoorden__ISO_nr._53__info" test="$keyword">Tenminste 1 trefwoord (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#trefwoord) is gevonden (<sch:value-of select="$keyword"/>)
			</sch:report>

		<!-- INSPIRE in combi met SDS interop INSPIRE -->
			<sch:assert id="Rol_organisatie_SDS_ISO_nr._379_" test="not($conformity_Spec_Title_SDS_Interop) or ($conformity_Spec_Title_SDS_Interop and contains($responsibleParty_Role, 'custodian'))">Rol organisatie (ISO nr. 379) ontbreekt of heeft een verkeerde waarde, voor INSPIRE interoperable SDS in ieder geval de rol beheerder opnemen</sch:assert>
			<sch:assert id="Rol_organisatie_SDS_harmo_ISO_nr._379_" test="not($conformity_Spec_Title_SDS_Harmo) or ($conformity_Spec_Title_SDS_Harmo and contains($responsibleParty_Role, 'custodian'))">Rol organisatie (ISO nr. 379) ontbreekt of heeft een verkeerde waarde, voor INSPIRE harmonised SDS in ieder geval de rol beheerder opnemen</sch:assert>
			<sch:report id="Rol_organisatie_SDS_ISO_nr._379__info" test="$conformity_Spec_Title_SDS_Interop">Rol verantwoordelijke organisatie (ISO nr. 379): <sch:value-of select="$conformity_Spec_Title_SDS_Interop"/>
			</sch:report>
		<!-- eind INSPIRE in combi met SDS INSPIRE -->
		<!-- alleen INSPIRE -->
		<!-- TODO: test if the Anchor construction works -->
		<!--
		...
		<!-- eind alleen INSPIRE -->
			...
			<sch:assert id="Gebruiksbeperkingen__ISO_nr._68_" test="$useLimitation">Gebruiksbeperkingen (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#gebruiksbeperkingen) ontbreken</sch:assert>
			<sch:report id="Gebruiksbeperkingen__ISO_nr._68__info" test="$useLimitation">Gebruiksbeperkingen (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#gebruiksbeperkingen): <sch:value-of select="$useLimitation"/>
			</sch:report>
			<sch:assert id="Overige_beperkingen_1_Anchor_URI_aanwezig" test="$otherConstraintURI1 and $otherConstraintURI1/@xlink:href">Overige beperkingen eerste element: de URI (xlink:href) dient ingevuld te zijn</sch:assert>
			<sch:assert id="Overige_beperkingen_2_Anchor_URI_aanwezig" test="$otherConstraintURI2 and $otherConstraintURI2/@xlink:href">Overige beperkingen tweede element: de URI (xlink:href) dient ingevuld te zijn</sch:assert>
			...
			<sch:assert id="_Juridische__toegangsrestricties__ISO_nr._70_" test="$accessConstraints_value">(Juridische) toegangsrestricties (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#juridische-toegangsrestricties) dient de waarde 'anders' te hebben in combinatie met een publiek domein, CC0 of GeoGedeeld licentie bij overige beperkingen (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#overige-beperkingen)</sch:assert>
			<sch:assert id="Overige_beperkingen__ISO_nr_72_" test="not($accessConstraints_value = 'otherRestrictions') or ($accessConstraints_value = 'otherRestrictions' and $otherConstraint1 and $otherConstraint2)">Het element overige beperkingen (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#overige-beperkingen) dient twee maal binnen dezelfde toegangsrestricties voor te komen; één met de beschrijving en één met de URL naar de publiek domein, CC0 of GeoGedeeld licentie,als (juridische) toegangsrestricties (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#juridische-toegangsrestricties) de waarde 'anders' heeft</sch:assert>
			<sch:report id="Overige_beperkingen__ISO_nr_72__1_info" test="$otherConstraint1">Overige beperkingen (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#overige-beperkingen) 1: <sch:value-of select="$otherConstraint1"/>
			</sch:report>
			<sch:report id="Overige_beperkingen__ISO_nr_72__2_info" test="$otherConstraint2">Overige beperkingen (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#overige-beperkingen) 2: <sch:value-of select="$otherConstraint2"/>
			</sch:report>

			<sch:report id="_Juridische__toegangsrestricties__ISO_nr._70__info"  test="$accessConstraints_value">(Juridische) toegangsrestricties (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#juridische-toegangsrestricties) aanwezig: <sch:value-of select="$accessConstraints_value"/>
			</sch:report>
			...
			<!-- <sch:assert id="Code referentiesysteem (ISO nr. 207)" test="$referenceSystemInfo">Code referentiesysteem (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#codereferentiesysteem) ontbreekt</sch:assert> -->
		...
		<!-- https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#url -->
			...
			<!-- Nieuw, Parameter naam. TODO: check wat er aan assertions nodig is voor: https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#parameter-naam  -->
		...
		<!-- dcp -->
		<!-- TODO: is alleen verplicht als er een coupled resource is? -->
			<sch:assert id="DCP" test="$dcp_value = 'WebServices'"> DCP ontbreekt  of heeft de verkeerde waarde </sch:assert>
			<sch:report id="DCP_info" test="$dcp_value">DCP: <sch:value-of select="$dcp_value"/></sch:report>
		<!-- operationName -->
		<!-- TODO: is alleen verplicht als er een coupled resource is? -->
			<sch:assert id="Operatie_naam" test="$operationName">Operatie naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#operatie-naam) ontbreekt of heeft de verkeerde waarde.</sch:assert>
			<sch:report id="Operatie_naam_info" test="$operationName">Operatie naam: <sch:value-of select="$operationName"/></sch:report>
		<!-- connectPoint https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#connectie-url -->
		<!-- TODO: is alleen verplicht als er een coupled resource is? -->
			<sch:assert id="Connectie_URL" test="$connectPointString">De connectie URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#connectie-url) ontbreekt of heeft de verkeerde waarde </sch:assert>
			<sch:report id="Connectie_URL_info" test="$connectPointString">Connectie URL: <sch:value-of select="$connectPointString"/></sch:report>

		 <!-- resourceLocator -->
		 <!-- TODO: Thijs: check of deze assertions nog steeds nodig / geldig zijn. Eventueel herschrijven, voor de leesbaarheid? -->
			<sch:assert id="URL_en_connectpoint_Linkage_1" test="not((not($connectPoint) and not($resourceLocator)) and not($resourceLocatorString=$connectPointString))">URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#url) heeft niet dezelfde waarde als de connectie URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#connectie-url)</sch:assert>
			<sch:assert id="URL_en_connectpoint_Linkage_2" test="not(($connectPoint and not($resourceLocator)) and not($resourceLocatorString=$connectPoint))">URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#url) heeft niet dezelfde waarde als de connectie URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#connectie-url)</sch:assert>
			<sch:assert id="URL_en_connectpoint_Linkage_3" test="not(($resourceLocator and not($connectPoint)) and not($resourceLocator=$connectPointString))">URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#url) heeft niet dezelfde waarde als de connectie URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#connectie-url)</sch:assert>
			<sch:assert id="URL_en_connectpoint_Linkage_4" test="not(($connectPoint and $resourceLocator) and not($resourceLocator=$connectPoint))">URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#url) heeft niet dezelfde waarde als de connectie URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#connectie-url)</sch:assert>

			<sch:assert id="URL" test="$resourceLocatorString">De URL (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#url) is verplicht als er een link is naar de service</sch:assert>
			<sch:report id="URL_info" test="$resourceLocatorString">URL: <sch:value-of select="$resourceLocatorString"/>
			</sch:report>

	   	 <!-- protocol: https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#protocol -->
			<sch:assert id="Protocol__ISO_nr._398_" test="not($resourceLocatorString) or ($resourceLocatorString and $transferOptions_Protocol)">Protocol (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#protocol) is verplicht als URL is ingevuld.</sch:assert>
			<sch:report id="Protocol__ISO_nr._398__info" test="$transferOptions_Protocol">Protocol (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#protocol): <sch:value-of select="normalize-space(gmd:identificationInfo[1]/*/gmd:transferOptions[1]/*/gmd:onLine/*/gmd:protocol/*/text())"/>
			</sch:report>
		...
		<!-- service type -->
			<sch:assert id="Service_type" test="$serviceType">Service type (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#service-type) ontbreekt of heeft de verkeerde waarde, gebruik view of download voor services die aan betreffende specificaties van INSPIRE voldoen, in andere gevallen de waarde other.</sch:assert>
			<sch:report id="Service_type_info" test="$serviceType">Service type: <sch:value-of select="$serviceType_value"/></sch:report>

	<!-- INSPIRE service type -->
			<sch:assert id="Service_type_en_network_specificatie" test="not($conformity_Spec_Title_Network_Exsists) or ($conformity_Spec_Title_Network_Exsists and $serviceType_Networkservice)">Service type ontbreekt of heeft de verkeerde waarde, gebruik view of download voor services die aan betreffende specificaties van INSPIRE voldoen.</sch:assert>
			<sch:assert id="Service_type_en_SDS_specificatie" test="not($conformity_Spec_Title_SDS_Exsists) or ($conformity_Spec_Title_SDS_Exsists and $serviceType_Other)">Service type ontbreekt of heeft de verkeerde waarde, gebruik de waarde other voor SDS services die aan betreffende specificaties van INSPIRE voldoen.</sch:assert>
	...
	<!-- eind alleen INSPIRE specificatie in combi met servicetype -->
		<!-- INSPIRE SDS -->
			<sch:assert id="Beschrijving" test="not($conformity_Spec_Title_SDS_Exsists) or ($conformity_Spec_Title_SDS_Exsists and $transferOptions_Description_Value = 'accessPoint')">beschrijving ontbreekt of heeft de verkeerde waarde, gebruik voor INSPIRE SDS de waarde accessPoint</sch:assert>
			<sch:report id="Beschrijving_info" test="$transferOptions_Description_Value">Service type: <sch:value-of select="$transferOptions_Description_Value"/></sch:report>
			<sch:assert id="Resource_locator_URL_getCapabilities" test="not($conformity_Spec_Title_SDS_Exsists) or ($conformity_Spec_Title_SDS_Exsists and contains(translate($resourceLocatorString, $lowercase, $uppercase),'GETCAPABILITIES'))">URL naar de service moet een getCapabilities request bevatten</sch:assert>

	<!-- eind  INSPIRE	SDS-->
			<!-- couplingType -->
			<sch:assert id="Coupling_type" test="$couplingType">Coupling type ontbreekt of heeft de verkeerde waarde</sch:assert>
			<sch:report id="Coupling_type_info" test="$couplingType">Coupling type: <sch:value-of select="$couplingType_value"/>
		   	</sch:report>
		...
		<!-- Coupled resource afhankelijk van data koppeling, https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#gekoppelde-bron
		Bij tight en mixed moet er een xlink opgenomen zijn
		-->
			<sch:assert id="coupledResource_met_xlink" test="not($couplingType_value='tight' or $couplingType_value='mixed') or (($couplingType_value='tight' or $couplingType_value='mixed') and $coupledResourceXlink)">Gekoppelde bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#gekoppelde-bron) met xlink is verplicht indien data aan de service is gekoppeld (coupled resource 'tight' of 'mixed').</sch:assert>


		<!-- extent https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#omgrenzende-rechthoek -->
			<sch:assert id="Geografisch_gebied" test="not($couplingType_value='tight' or $couplingType_value='mixed') or (($couplingType_value='tight' or $couplingType_value='mixed') and $geographicLocation)">Geografisch gebied  is verplicht indien data aan de service is gekoppeld (coupled resource 'tight' of 'mixed').</sch:assert>
			<sch:report id="Geografisch_gebied_info" test="($couplingType_value='tight' or $couplingType_value='mixed') and $geographicLocation">Geografisch gebied : <sch:value-of select="$geographicLocation"/>
			</sch:report>
			<sch:assert id="Minimum_x-coordinaat__ISO_nr._344_"  test="(-180.00 &lt; $west) and ( $west &lt; 180.00) or ( $west = 0.00 ) or ( $west = -180.00 ) or ( $west = 180.00 )">Minimum x-coördinaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#omgrenzende-rechthoek) ontbreekt of heeft een verkeerde waarde</sch:assert>
			<sch:report id="Minimum_x-coordinaat__ISO_nr._344__info" test="(-180.00 &lt; $west) and ( $west &lt; 180.00) or ( $west = 0.00 ) or ( $west = -180.00 ) or ( $west = 180.00 )">Minimum x-coördinaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#omgrenzende-rechthoek): <sch:value-of select="$west"/>
			</sch:report>
			<sch:assert id="Maximum_x-coordinaat__ISO_nr._345_"  test="(-180.00 &lt; $east) and ($east &lt; 180.00) or ( $east = 0.00 ) or ( $east = -180.00 ) or ( $east = 180.00 )">Maximum x-coördinaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#omgrenzende-rechthoek) ontbreekt of heeft een verkeerde waarde</sch:assert>
			<sch:report id="Maximum_x-coordinaat__ISO_nr._345__info"  test="(-180.00 &lt; $east) and ($east &lt; 180.00) or ( $east = 0.00 ) or ( $east = -180.00 ) or ( $east = 180.00 )">Maximum x-coördinaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#omgrenzende-rechthoek): <sch:value-of select="$east"/>
			</sch:report>
			<sch:assert id="Minimum_y_coordinaat__ISO_nr._346_" test="(-90.00 &lt; $south) and ($south &lt; $north) or (-90.00 = $south) or ($south = $north)">Minimum y-coördinaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#omgrenzende-rechthoek) ontbreekt of heeft een verkeerde waarde</sch:assert>
			<sch:report id="Minimum_y_coordinaat__ISO_nr._346__info" test="(-90.00 &lt; $south) and ($south &lt; $north) or (-90.00 = $south) or ($south = $north)">Minimum y-coördinaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#omgrenzende-rechthoek): <sch:value-of select="$south"/>
			</sch:report>
			<sch:assert id="Maximum_y-coordinaat__ISO_nr._347_" test="($south &lt; $north) and ($north &lt; 90.00) or ($south = $north) or ($north = 90.00)">Maximum y-coördinaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#omgrenzende-rechthoek) ontbreekt of heeft een verkeerde waarde</sch:assert>
			<sch:report id="Maximum_y-coordinaat__ISO_nr._347__info" test="($south &lt; $north) and ($north &lt; 90.00) or ($south = $north) or ($north = 90.00)">Maximum y-coördinaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#omgrenzende-rechthoek): <sch:value-of select="$north"/>
			</sch:report>
		...
		<!-- rules and assertions -->
			<sch:assert id="Niveau_kwaliteitsbeschrijving__ISO_nr.139_" test="$level">Niveau kwaliteitsbeschrijving (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#niveau-kwaliteitsbeschrijving) ontbreekt of heeft een verkeerde waarde. Alleen 'service' is toegestaan</sch:assert>
			<sch:report id="Niveau_kwaliteitsbeschrijving__ISO_nr.139__info" test="$level">Niveau kwaliteitsbeschrijving (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#niveau-kwaliteitsbeschrijving): <sch:value-of select="$level"/>
			</sch:report>

			<sch:assert id="Niveau_kwaliteitsbeschrijving_naam" test="$levelDescription">Niveau kwaliteitsbeschrijving naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#niveau-kwaliteitsbeschrijving-naam) ontbreekt of heeft een verkeerde waarde. Alleen 'service' is toegestaan</sch:assert>
			<sch:report id="Niveau_kwaliteitsbeschrijving_naam_info" test="$levelDescription">Niveau kwaliteitsbeschrijving naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#niveau-kwaliteitsbeschrijving-naam): <sch:value-of select="$level"/>
			</sch:report>
		...
		<!-- Voor niet INSPIRE data als title is ingevuld, moeten date, datetype, explanation en pass ingevuld zijn -->
			...
			<sch:assert id="Verklaring_ISO_nr._131__en_Specificatie__ISO_nr._360_" test="not($conformity_SpecTitle) or ($conformity_SpecTitle and $conformity_Explanation)">Verklaring (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verklaring) is verplicht als een specificatie (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#specificatie) is opgegeven.</sch:assert>
			<sch:assert id="Datum__ISO_nr._394__en_Specificatie__ISO_nr._360_" test="not($conformity_SpecTitle and not($conformity_Date))">Datum (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#specificatiedatum) is verplicht als een specificatie (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#specificatie) is opgegeven. </sch:assert>
			...
			<sch:assert id="Conformiteit__ISO_nr._132___en_Specificatie__ISO_nr_360_" test="not($conformity_SpecTitle) or ($conformity_SpecTitle and $conformity_Pass)">Conformiteit (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#conformiteit-indicatie-met-de-specificatie) is verplicht als een specificatie (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#specificatie) is opgegeven.</sch:assert>


		<!-- als er geen titel is ingevuld, moeten date, datetype explanation en pass leeg zijn -->
			<sch:assert id="Verklaring__ISO_nr._131_" test="not($conformity_Explanation) or ($conformity_Explanation and $conformity_SpecTitle)">Verklaring (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verklaring) hoort leeg te zijn als geen specificatie is opgegeven</sch:assert>
			<sch:assert id="Datum__ISO_nr._394_" test="not($conformity_Date and not($conformity_SpecTitle))">Datum (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#specificatiedatum) hoort leeg te zijn als geen specificatie is opgegeven. </sch:assert>
			<sch:assert id="Datumtype__ISO_nr._395_" test="not($conformity_Datetype and not($conformity_SpecTitle))">Datumtype (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#specificatiedatum-type) hoort leeg te zijn als geen specificatie is opgegeven.</sch:assert>
			<sch:assert id="Conformiteit_ISO_nr._132" test="not($conformity_Pass) or ($conformity_Pass and $conformity_SpecTitle)">Conformiteit (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#conformiteit-indicatie-met-de-specificatie) hoort leeg te zijn als geen specificatie is opgegeven.</sch:assert>

			<sch:report id="Verklaring__ISO_nr._131__info" test="$conformity_Explanation">Verklaring (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#verklaring): <sch:value-of select="$conformity_Explanation"/>
			</sch:report>
			<sch:report id="Conformiteitindicatie_met_de_specificatie__ISO_nr._132__info" test="$conformity_Pass">Conformiteitindicatie met de specificatie (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#conformiteit-indicatie-met-de-specificatie): <sch:value-of select="$conformity_Pass"/>
			</sch:report>
			<sch:report id="Specificatie__ISO_nr._360__info" test="$conformity_SpecTitleString or $conformity_SpecTitleURI">Specificatie (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#specificatie): <sch:value-of select="$conformity_SpecTitleString"/><sch:value-of select="$conformity_SpecTitleURI"/>
			</sch:report>
		...
		<sch:rule id="alle_INSPIRE_specificaties" context="//gmd:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:report/gmd:DQ_DomainConsistency/gmd:result/gmd:DQ_ConformanceResult/gmd:specification/gmd:CI_Citation">
		...
		-->
		<sch:rule id="Parameter_elementen" context="//gmd:MD_Metadata/gmd:identificationInfo/*/srv:containsOperations/*/srv:parameters/srv:SV_Parameter">
			<!-- TODO: testcases maken / navragen -->
			<!-- Naam https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#parameter-naam, TODO: check klopt het xpath? -->
			...
			<sch:assert id="Parameter_naam" test="$parameterName">Parameter naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#parameter-naam) is niet beschreven</sch:assert>
			<sch:assert id="Parameter_optionaliteit" test="$parameterOptionality">Parameter optionaliteit (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#parameter-optionaliteit) is niet beschreven</sch:assert>
			<sch:assert id="Parameter_herhaalbaarheid" test="$parameterRepeatability">Parameter herhaalbaarheid (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#parameter-herhaalbaarheid) is niet beschreven</sch:assert>
		</sch:rule>

		<!-- Operates on-->
		<sch:rule id="Relatie_met_de_dataset" context="//gmd:MD_Metadata/gmd:identificationInfo/srv:SV_ServiceIdentification/srv:operatesOn">
			...
			<sch:assert id="Coupled_resource_xlink_href_attribuut" test="string(normalize-space(@xlink:href))">Coupled resource heeft geen xlink:href attribuut bij het element operatesOn</sch:assert>
		</sch:rule>

		<!-- INSPIRE interop interoperabele servicekwaliteit  -->
		<!-- TODO: assertion om te checken of iets een INSPIRE interoperabele service is? -->
		<sch:rule id="INSPIRE_interoperabele_service_-_service_kwaliteit" context="//gmd:MD_Metadata/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:report/gmd:DQ_ConceptualConsistency">
			<!-- anchor verplicht -->
			<!-- TODO: test of dit werkt -->
			<sch:let name="all_quality_measures" value="ancestor::gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:report/gmd:DQ_ConceptualConsistency/gmd:nameOfMeasure/gmx:Anchor"/>
			<sch:let name="all_quality_measures_join" value="normalize-space(string-join(($all_quality_measures), ','))"/>

			<sch:let name="quality_name_Of_Measure" value="normalize-space(gmd:nameOfMeasure/gmx:Anchor)"/>

			<sch:let name="quality_name_Of_Measure_Availability" value="normalize-space(gmd:nameOfMeasure/gmx:Anchor[@xlink:href='http://inspire.ec.europa.eu/metadata-codelist/QualityOfServiceCriteriaCode/availability'])"/>
			<sch:let name="quality_name_Of_Measure_Performance" value="normalize-space(gmd:nameOfMeasure/gmx:Anchor[@xlink:href='http://inspire.ec.europa.eu/metadata-codelist/QualityOfServiceCriteriaCode/performance'])"/>
			<sch:let name="quality_name_Of_Measure_Capacity" value="normalize-space(gmd:nameOfMeasure/gmx:Anchor[@xlink:href='http://inspire.ec.europa.eu/metadata-codelist/QualityOfServiceCriteriaCode/capacity'])"/>
			...
			<!-- TODO: test deze parameters -->
			<sch:let name="quality_measure_Description_Availability" value="normalize-space(gmd:measureDescription[../gmd:nameOfMeasure/gmx:Anchor/@xlink:href='http://inspire.ec.europa.eu/metadata-codelist/QualityOfServiceCriteriaCode/availability']/gco:CharacterString)"/>
			<sch:let name="quality_measure_Description_Performance" value="normalize-space(gmd:measureDescription[../gmd:nameOfMeasure/gmx:Anchor/@xlink:href='http://inspire.ec.europa.eu/metadata-codelist/QualityOfServiceCriteriaCode/performance']/gco:CharacterString)"/>
			<sch:let name="quality_measure_Description_Capacity" value="normalize-space(gmd:measureDescription[../gmd:nameOfMeasure/gmx:Anchor/@xlink:href='http://inspire.ec.europa.eu/metadata-codelist/QualityOfServiceCriteriaCode/capacity']/gco:CharacterString)"/>
			...
			<sch:let name="quality_result_Availability" value="normalize-space(gmd:result[../gmd:nameOfMeasure/gmx:Anchor/@xlink:href='http://inspire.ec.europa.eu/metadata-codelist/QualityOfServiceCriteriaCode/availability']/gmd:DQ_QuantitativeResult/gmd:value/gco:Record)"/>
			<sch:let name="quality_result_Performance" value="normalize-space(gmd:result[../gmd:nameOfMeasure/gmx:Anchor/@xlink:href='http://inspire.ec.europa.eu/metadata-codelist/QualityOfServiceCriteriaCode/performance']/gmd:DQ_QuantitativeResult/gmd:value/gco:Record)"/>
			<sch:let name="quality_result_Capacity" value="normalize-space(gmd:result[../gmd:nameOfMeasure/gmx:Anchor/@xlink:href='http://inspire.ec.europa.eu/metadata-codelist/QualityOfServiceCriteriaCode/capacity']/gmd:DQ_QuantitativeResult/gmd:value/gco:Record)"/>

			<!-- https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-type-waarde -->
			<sch:let name="quality_value_unit" value="normalize-space(gmd:result/gmd:DQ_QuantitativeResult/gmd:valueUnit/@xlink:href)"/>
			<sch:let name="quality_value_unit_Availability" value="normalize-space(gmd:result[../gmd:nameOfMeasure/gmx:Anchor/@xlink:href='http://inspire.ec.europa.eu/metadata-codelist/QualityOfServiceCriteriaCode/availability']/gmd:DQ_QuantitativeResult/gmd:valueUnit/@xlink:href)"/>
			<sch:let name="quality_value_unit_Performance" value="normalize-space(gmd:result[../gmd:nameOfMeasure/gmx:Anchor/@xlink:href='http://inspire.ec.europa.eu/metadata-codelist/QualityOfServiceCriteriaCode/performance']/gmd:DQ_QuantitativeResult/gmd:valueUnit/@xlink:href)"/>
			<sch:let name="quality_value_unit_Capacity" value="normalize-space(gmd:result[../gmd:nameOfMeasure/gmx:Anchor/@xlink:href='http://inspire.ec.europa.eu/metadata-codelist/QualityOfServiceCriteriaCode/capacity']/gmd:DQ_QuantitativeResult/gmd:valueUnit/@xlink:href)"/>

			<!-- TODO: is dit nog ergens voor nodig? mag het een nilReason zijn voor de service kwaliteit? -->
			...
			<!-- SDS veranderd in interoperabele service -->
			<sch:report id="INSPIRE_interoperabele_service_kwaliteit__ISO_nr._100___availability_info" test="$all_quality_measures_join">Aanwezige kwaliteits meetingen: <sch:value-of select="$all_quality_measures_join"/>
			</sch:report>

			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_identificatie__ISO_nr._101__" test="not($quality_name_Of_Measure) or ($quality_name_Of_Measure and $quality_measure_Identification)">Identificatie van service kwaliteitsmeeting (ISO nr. 101) is verplicht als een meeting is opgegeven.</sch:assert>
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_beschrijving__ISO_nr._--102__" test="not($quality_name_Of_Measure) or ($quality_name_Of_Measure and $quality_measure_Description)">Beschrijving van service kwaliteit (ISO nr. 102) is verplicht als een meeting is opgegeven.</sch:assert>
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_resultaat__ISO_nr._107" test="not($quality_name_Of_Measure) or ($quality_name_Of_Measure and $quality_result)">Resultaat van service kwaliteit (ISO nr. 107) is verplicht als een meeting is opgegeven.</sch:assert>
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_eenheid_waarde__ISO_nr._107__" test="not($quality_name_Of_Measure) or ($quality_name_Of_Measure and ($quality_value_unit or $quality_value_unit_Reason))">Voor resultaat van service kwaliteit (ISO nr. 107) is ook een eenheid verplicht als een meeting is opgegeven.</sch:assert>


			<!-- TODO: test file -->
			<!-- TODO: conditioneel: verplicht voor INSPIRE interoperabele services -->
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_beschikbaarheid" test="$quality_name_Of_Measure_Availability">De beschikbaarheid van de service is niet beschreven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria)</sch:assert>
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_performance" test="$quality_name_Of_Measure_Performance">De performance van de service is niet beschreven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria)</sch:assert>
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_capaciteit" test="$quality_name_Of_Measure_Capacity">De capaciteit van de service is niet beschreven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria)</sch:assert>

			<!-- TODO: conditioneel: verplicht voor INSPIRE interoperabele services -->
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_beschikbaarheid_2" test="$quality_measure_Description_Availability">De criterium beschrijving van de beschikbaarheid van de service is niet opgegeven  (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-beschrijving)</sch:assert>
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_performance_2" test="$quality_measure_Description_Performance">De criterium beschrijving van de performance van de service is niet opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-beschrijving)</sch:assert>
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_capaciteit_2" test="$quality_measure_Description_Capacity">De criterium beschrijving van de capaciteit van de service is niet opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-beschrijving)</sch:assert>


			<!-- TODO: conditioneel: verplicht voor INSPIRE interoperabele services -->
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_beschikbaarheid_type_waarde" test="$quality_value_unit_Availability='urn:ogc:def:uom:OGC::percent'">Het type waarde voor de beschikbaarheid van de service is niet correct opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-type-waarde). Het moet zijn: 'urn:ogc:def:uom:OGC::percent', maar '<sch:value-of select="$quality_value_unit_Availability"/>' is opgegeven.</sch:assert>
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_performance_type_waarde" test="$quality_value_unit_Performance=' 	http://www.opengis.net/def/uom/SI/second'">Het type waarde voor de performance van de service is niet correct opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-type-waarde). Het moet zijn: 'http://www.opengis.net/def/uom/SI/second', maar '<sch:value-of select="$quality_value_unit_Performance"/>' is opgegeven.</sch:assert>
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_capaciteit_type_waarde" test="$quality_value_unit_Capacity='http://www.opengis.net/def/uom/OGC/1.0/unity'">Het type waarde voor de capaciteit van de service is niet correct opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-type-waarde). Het moet zijn: 'http://www.opengis.net/def/uom/OGC/1.0/unity', maar '<sch:value-of select="$quality_value_unit_Performance"/>' is opgegeven.</sch:assert>

			<!-- TODO: conditioneel: verplicht voor INSPIRE interoperabele services -->
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_beschikbaarheid_waarde" test="$quality_result_Availability">De meetwaarde voor de beschikbaarheid van de service is niet correct opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-waarde).</sch:assert>
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_performance_waarde" test="$quality_result_Performance">De meetwaarde voor de performance van de service is niet correct opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-waarde).</sch:assert>
			<sch:assert id="INSPIRE_interoperabele_service_kwaliteit_capaciteit_waarde" test="$quality_result_Capacity">De meetwaarde voor de capaciteit van de service is niet correct opgegeven (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#criteria-waarde).</sch:assert>
		...
		TODO: niet specifiek voor SDS anders ?
		-->
		<!-- Referentiesysteem  -->
		<sch:rule id="Referentiesysteem" context="//gmd:MD_Metadata/gmd:referenceSystemInfo/*">
			<!--  Ruimtelijk referentiesysteem  https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#codereferentiesysteem -->
			<!-- Geen RS_Identifier meer, maar alleen een MD_Identifier -->
			<sch:let name="referenceSystemInfo_CodeString" value="normalize-space(gmd:referenceSystemIdentifier/gmd:MD_Identifier/gmd:code/gco:CharacterString)"/>
			<sch:let name="referenceSystemInfo_CodeURI" value="normalize-space(gmd:referenceSystemIdentifier/gmd:MD_Identifier/gmd:code/gmx:Anchor/@xlink:href)"/>

			<sch:assert id="Code_referentiesysteem__ISO_nr._207_" test="$referenceSystemInfo_CodeString or $referenceSystemInfo_CodeURI">Code referentiesysteem (https://docs.geostandaarden.nl/md/mdprofiel-iso19119/#codereferentiesysteem) ontbreekt</sch:assert>
		...
		<!-- eind INSPIRE SDS Referentiesysteem  -->
        		...
        		<!-- Controlled originating vocabulary -   -->
		<sch:rule id="INSPIRE_Thesaurus_trefwoorden" context="//gmd:MD_Metadata/gmd:identificationInfo[1]/*/gmd:descriptiveKeywords
			...
			<sch:assert id="INSPIRE_Trefwoorden__ISO_nr._53__uit_thesaurus" test="((normalize-space(current())='Administratieve eenheden'
)
