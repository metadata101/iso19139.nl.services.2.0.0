...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 <!-- Required for utility-fn.xsl -->
  ...
  <xsl:template mode="getMetadataThumbnail" match="gmd:MD_Metadata">
    <xsl:value-of select="gmd:identificationInfo/*/gmd:graphicOverview[1]/gmd:MD_BrowseGraphic/gmd:fileName/gco:CharacterString[starts-with(normalize-space(.),'http')]"/>
  </xsl:template>
  ...
  <xsl:template mode="getOverviews" match="gmd:MD_Metadata">
    <section class="gn-md-side-overview">
      ...
      <xsl:for-each select="gmd:identificationInfo/*/gmd:graphicOverview/*[starts-with(normalize-space(.),'http')]">
